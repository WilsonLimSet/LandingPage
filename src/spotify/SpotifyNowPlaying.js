  ...
  return (
    <Center>
      ...
      <ul style={{ paddingLeft: '60px' }}>
        ...
        <li><span style={{ fontWeight: 'bold' }}>Books.</span> I am currently reading <a href="https://www.goodreads.com/book/show/18000799-ken-kaskus"
          target="_blank" style={{
            color: 'blue', fontStyle: 'italic', textDecoration: 'underline',
            fontWeight: 'bold'
          }}>Ken & Kaskus</a>.
        ...
        {loading ?
          ...
          <Stack width="full" mb={result.isPlaying ? 2 : 4} spacing={3}>
            ...
            {result.isPlaying &&
             ...
             <Stack spacing={2} direction="row" align="center">
            <OuraRingLogo />
            <Text fontWeight="semibold">{sleepDate ? `${sleepDate} ${sleepDataText || 'Sleep Score Error'}` : 'Date Error'} {sleepDataText ? sleepDataText : 'Sleep Score Error'}</Text> 
